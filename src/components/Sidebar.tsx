    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-3 px-4 py-5 border-b border-slate-100">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-cyan-500 text-white shadow-[0_4px_15px_rgba(0,230,118,0.3)]">
            ...
            <div className={`border-b border-slate-100 px-4 py-5 ${collapsed ? 'flex justify-center' : ''}`}>
                <div className={`flex ${collapsed ? 'flex-col items-center' : 'items-center gap-3'}`}>
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-emerald-400 to-cyan-500 text-sm font-bold text-white shadow-[0_0_20px_rgba(0,230,118,0.25)]">
                        {initials}
                    </div>
                    <AnimatePresence>
                        {!collapsed && (
