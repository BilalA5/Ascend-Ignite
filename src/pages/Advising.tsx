                            ...
                            <CardContent className="p-0 sm:flex flex-row-reverse">
                                ...
                                <div className="p-6 flex-1 flex flex-col justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm font-medium text-slate-700 mb-4 border-b border-slate-100 pb-4">Led by: {event.speaker}</p>
                                        <p className="text-slate-600 leading-relaxed max-w-2xl">{event.description}</p>
                                    </div>
                                    <div className="mt-6">
                                        {registeredEvents[event.id] ? (
                                            <div className="inline-flex items-center gap-2 text-green-600 font-medium px-4 py-2 bg-green-50 rounded-md">
